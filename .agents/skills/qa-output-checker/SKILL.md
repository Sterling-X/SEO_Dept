...
extract-text document.docx | grep -iE "\[.*\]|TBD|TK|TODO|PLACEHOLDER|INSERT|LOREM|FIXME|XXX|<.*>|YOUR NAME|CLIENT NAME|FIRM NAME"
```
...
- [ ] No `[INSERT]`, `[TBD]`, `[CLIENT NAME]`, `[FIRM NAME]`, `[DATE]`, `[MARKET]` or equivalent brackets remaining

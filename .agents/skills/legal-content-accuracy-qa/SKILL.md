---
name: legal-content-accuracy-qa
...
- Apply only the client-specific and compliance rules confirmed for the active client (load the client's voice skill if present). Do not import voice, compliance, terminology, or legal-content rules from another client or project.
...
- **Result** is one of: Confirmed, Corrected, Flagged (overbroad, incomplete, or misleading), Unverifiable.

# FL-M008 local replacement record (pilot candidate v1)

> **LOCAL REPLACEMENT / NOT RECOVERED ORIGINAL**
>
> **PILOT CANDIDATE v1.** This directory is a candidate copy of the baseline local replacement at
> `.agents/skills/family-law-situational-pages`; see `pilot-manifest.json` for baseline hashes and
> `CHANGES.md` for every difference. It is outside skill discovery and is used only when a
> content-workflow run pins it.
...
```sh
cd pilot/content-workflow/candidates/skills/family-law-situational-pages-pilot-v1
npm ci

...
2. Client specificity, evidence-based: every firm statement (offer, fee model, process,
   credential, staffing, service area, response time, outcome) traces to the approved client
   facts within their approved scope; no other client's facts. A neutral, accurate legal
   explanation is acceptable even if another firm could publish it; do not fail a passage as
   generic without naming a concrete defect (wrong or unsupported firm claim, a documented
   voice contradiction, or a scenario connection the brief requires and the page lacks).

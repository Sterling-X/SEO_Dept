...
4. Have `seo_reviewer` assess both the evidence and the proposed persistent change. The reviewer should flag overfitting, conflicting instructions, and evaluation gaps.
5. Test with fixed criteria on:
